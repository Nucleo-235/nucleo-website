class IndexesMailer < ApplicationMailer
  ...
  def sales(indexes, base_date)
    ...
    mail(from: "Nucleo Reporter <#{mail_from}>", to: ENV['ADMIN_MAIL'], subject: "Índices de Venda (#{@goal_version})")
  end
  ...
  def execution(indexes, base_date)
    ...
    @base_date = base_date
    mail_from = ENV['MAILER_FROM'] || 'kikecomp@gmail.com'
    mail(from: "Nucleo Reporter <#{mail_from}>", to: ENV['ADMIN_MAIL'], subject: "Nucleo Índices")
  end
